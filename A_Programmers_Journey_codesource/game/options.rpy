...
define config.name = _("A Programmer's Journey")
...
define build.name = "AProgrammersJourney"
...
define config.main_menu_music = "audio/mist_covered_mountains.mp3"
...
define config.save_directory = "AProgrammersJourney-1709987589"
